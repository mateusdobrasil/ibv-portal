...
export default async function RelatoriosPage({ searchParams }: PageProps) {
  ...
  // =================================================================
  // 1. DADOS GERAIS DO INSTITUTO (Cards Superiores)
  // =================================================================
  ...
  if (frequencias) {
    frequencias.forEach(f => {
      ...
      // Registra métricas de classe do dia (pegando o maior valor registrado naquele dia para a turma)
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-indigo-100">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4 pb-6 border-b border-gray-100">
            <div>
              <h2 className="text-xl font-black text-indigo-900 flex items-center gap-2">📖 Relatório da EBD</h2>
              <p className="text-sm text-gray-500 mt-1">Desempenho e frequência das turmas da Escola Bíblica.</p>
            </div>
        ...
        {/* ========================================================= */}
        {/* ÁREA DE DETALHES INFERIORES (Financeiro e Dicas)          */}
        {/* ========================================================= */}
