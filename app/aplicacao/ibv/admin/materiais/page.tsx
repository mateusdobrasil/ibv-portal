...
export default async function AdminMateriaisPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ibv', 'materiais')

  if (!temAcesso) {
    redirect('/aplicacao/ibv') // Redireciona alunos e sem acesso
  }
