...
import { usuarioTemAcessoPagina, ehAdministrador, PAGINAS_IBV } from '@/lib/permissoes'
...
export default async function NiveisAcessoPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ibv', 'niveis-acesso')

  if (!temAcesso) {
    redirect('/aplicacao/ibv/admin') // Se for Administrativo ou Professor, volta para o Hub
  }
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/aplicacao/ibv/admin" className="text-sm bg-white border px-4 py-2 rounded-lg font-medium shadow-sm">Voltar</Link>
        </div>
                  ...
                  <div className="flex items-center gap-2">
                    {ehAdministrador(n.nome) ? (
                      ...
                      <PaginasDoCargo
                        modulo="ibv"
                        nivelAcesso={n.nome}
                        paginasDisponiveis={PAGINAS_IBV}
