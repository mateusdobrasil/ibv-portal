...
export default async function MateriasPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ibuc', 'materias')

  if (!temAcesso) {
    redirect('/aplicacao/ibuc') // Redireciona alunos e sem acesso para fora do painel
  }
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-col items-end gap-3 w-full sm:w-auto">
            ...
            <CriadorMateria cursos={cursosAtivos || []} modulo="ibuc" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <CriadorMateria materia={m} cursos={cursosAtivos || []} modulo="ibuc" />
                  </div>
                </div>
              )
            })
