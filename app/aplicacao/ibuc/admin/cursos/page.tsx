...
export default async function CursosPage() {
  ...
  const temAcesso = await usuarioTemAcessoPagina(supabase, perfil?.tipo_usuario, 'ibuc', 'cursos')

  if (!temAcesso) {
    redirect('/aplicacao/ibuc') // Se não tiver permissão, redireciona para fora do painel
  }
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <CriadorCurso curso={c} modulo="ibuc" />
                </div>
              </div>
            )
          })}
