      ...
      <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-slate-900 p-5 sm:p-6 text-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Link href="/aplicacao/ebd/admin/ebd" className="w-full sm:w-auto text-center text-sm bg-white/10 hover:bg-white/20 text-white px-4 py-2.5 rounded-lg font-bold transition border border-white/10">
              Voltar para Turmas
            </Link>
          </div>
        </div>
                  ...
                  alunos.map((aluno) => (
                    <tr key={aluno.matricula_id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-4 sm:px-6 py-4 text-right">
                        <Link href={`/aplicacao/ebd/admin/cadastro/${aluno.aluno_id}`} className="text-[10px] bg-gray-100 text-gray-600 px-3 py-2 rounded-lg font-bold hover:bg-slate-900 hover:text-white transition uppercase">
                          Perfil
                        </Link>
                      </td>
                    </tr>
