...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-blue-200">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-black text-xl text-blue-800 tracking-tight leading-none">IBV</h1>
              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Escola Teológica</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Link 
              href="/cadastro" 
              className="text-blue-600 font-bold hover:text-blue-800 transition text-sm hidden sm:block"
            >
              Criar Conta
            </Link>
            <Link 
              href="/login" 
              className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-semibold hover:bg-blue-700 transition shadow-sm text-sm"
            >
              Área do Aluno
            </Link>
          </div>
      ...
      <main>
        {/* HERO SECTION */}
        <section className="bg-gradient-to-b from-blue-900 to-indigo-900 text-white py-24 px-6 text-center">
        ...
        {/* CURSOS */}
        <section id="cursos" className="py-20 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-lg transition group">
                ...
                <p className="text-gray-500 text-sm mb-6 h-16">Destinado a novos convertidos ou irmãos que queiram iniciar os estudos teológicos.</p>
              ...
              {/* Curso Médio */}
              <div className="bg-blue-900 p-8 rounded-3xl shadow-xl transform md:-translate-y-4 relative">
                ...
                <span className="bg-blue-800 text-blue-200 border border-blue-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4 inline-block">Intermediário</span>
                <h3 className="text-2xl font-bold text-white mb-2">Médio em Teologia</h3>
                <p className="text-blue-200 text-sm mb-6 h-16">Para quem busca um aprofundamento sólido nas doutrinas e história da Igreja.</p>
                <div className="space-y-3 mb-8">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200 hover:shadow-lg transition group">
                ...
                <p className="text-gray-500 text-sm mb-6 h-16">Para líderes, professores e alunos que buscam a excelência no conhecimento bíblico.</p>
                <div className="space-y-3 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 flex flex-col sm:flex-row gap-6 items-center">
                <div className="bg-yellow-50 p-4 rounded-full text-3xl">📝</div>
                <div>
