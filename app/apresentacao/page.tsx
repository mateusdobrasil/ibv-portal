  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="text-center mb-6 flex flex-col items-center">
        ...
        />
        <h1 className="text-4xl font-bold text-gray-800">Painel Administrativo - Visitantes</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full max-w-5xl">
        ...
        {/* Card 1: Cadastro */}
        <Link href={isAcessoLiberado ? "/apresentacao/cadastro" : "#"}
        ...
        <Link href={isAcessoLiberado ? "/apresentacao/apresentacao" : "#"} 
              className={`bg-white p-8 rounded-xl border border-gray-100 flex flex-col items-center text-center group transition-all duration-300 ${isAcessoLiberado ? 'shadow-sm hover:shadow-md cursor-pointer' : 'opacity-40 cursor-not-allowed pointer-events-none grayscale'}`}>
        ...
        <Link href={isAcessoLiberado ? "/apresentacao/apresentacaoblack" : "#"} 
              className={`bg-white p-8 rounded-xl border border-gray-100 flex flex-col items-center text-center group transition-all duration-300 ${isAcessoLiberado ? 'shadow-sm hover:shadow-md cursor-pointer' : 'opacity-40 cursor-not-allowed pointer-events-none grayscale'}`}>
        ...
        {/* Card 4: Edição */}
        <Link href={isAcessoLiberado ? "/apresentacao/edicao" : "#"} 
              className={`bg-white p-8 rounded-xl border border-gray-100 flex flex-col items-center text-center group transition-all duration-300 ${isAcessoLiberado ? 'shadow-sm hover:shadow-md cursor-pointer' : 'opacity-40 cursor-not-allowed pointer-events-none grayscale'}`}>
